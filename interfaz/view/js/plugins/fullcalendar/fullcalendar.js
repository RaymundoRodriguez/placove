...
var defaults = {
	...
	isRTL: false,
	firstDay: 0,
	monthNames: ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembrr','Octubre','Noviembre','Diciembre'],
	monthNamesShort: ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembrr','Octubre','Noviembre','Diciembre'],
...
function ResourceView(element, calendar, viewName) {
	...
	function buildSkeleton(maxRowCnt, showNumbers) {
		...
		var headerClass = tm + "-widget-header";
		var contentClass = tm + "-widget-content";
		var i, j, id, resourceName,resourceClass;
		var table;
...
//			resourceClass = resources[i]['classe'];
			s +=
