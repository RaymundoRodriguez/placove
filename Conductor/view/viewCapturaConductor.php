    ...
    <body><br>
        <form id="formConductor">
            <div id="formCapturaConductor"  style="width: 100%; margin: 0 auto;" >
                ...
                <fieldset style="width:91%; height: 85%;margin: 0 auto">
                    ...
                    <div id="contenido" >
                        ...
                        <div id="fielCond">
                            <fieldset style="width:95%; height: 70%;" >
                                ...
                                <br> <br><strong>Color que identifica al conductor</strong>
                                <div id="divSelector">
                                    <p><strong>- seleccione un color haciendo clic -</strong></p>
                                    <input type="color" id="clrColor" value="#ff006f">

                                </div>
                                <div id="divColor" style="display: none;">#ff006f</div><br>
                            </fieldset>
                        </div>
                ...
                <br><br><div align= "center" style="margin: 0 auto">
                    <br> <input type="button" value="Guardar" id="btnGuardarConductor" name="btnGuardar" class="ui-state-default ui-corner-bottom ui-corner-top" style="font-family: Georgia,'Times New Roman',times,serif; font-size: 12px " />
                    <input type="button" value="Guardar y Anexar Otro" id="btnGuardarConductorOtro" name="btnGAnexar" class="ui-state-default ui-corner-bottom ui-corner-top" style="font-family: Georgia,'Times New Roman',times,serif; font-size: 12px " />
                    <input type="button" value="Cancelar" id="btnCancelarConductor" name="btnCancelar" class="ui-state-default ui-corner-bottom ui-corner-top" style="font-family: Georgia,'Times New Roman',times,serif; font-size: 12px " />
