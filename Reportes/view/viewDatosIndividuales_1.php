...
//                        if ($value['su'] == 0) {
                        ...
                        foreach ($cabecera as $key2 => $value2) {
                            ...
                            if ($cabecera[$key2][0] == 'Horas diarias') {
                                echo "<td>" . number_format($horasTotales, 2) . "</td>";
                                $horasTotales = 0;
                            } else {
                                ...
                                if ($cabecera[$key2][0] == 'Pct Avance') {
                                    $porcentaje+=$value['porcentaje_avance'];
...
//                        //porcentaje de avance por dia
                                    ...
                                    if ($key == 0) {
                                        ...
                                        echo "<td>" . abs($value['porcentaje_avance']) . "%</td>";

                                        $diferencia = $value['porcentaje_avance'];
                                    }
                                } elseif ($cabecera[$key2][0] == 'KM/dia Aprox') {
...
$km_sumaxdia=number_format(( $diferenciaKMApro * $kmLineales) / 100, 2);
                                    echo "<td>" .$km_sumaxdia . " Km</td>";

                                    $diferenciaKMapro = $value['porcentaje_avance'];
                                } elseif ($cabecera[$key2][0] == 'KM/HR colectados Aprox') {
                                    ...
                                    if (number_format((( $diferencia2 * $kmLineales) / 100) / $tiempo_FDC) < 5) {
                                        ...
                                        echo "<td bgcolor='#F78181'>" . number_format((( $diferencia2 * $kmLineales) / 100) / $tiempo_FDC, 2) . "  Km</td>";
                                    } else {

                                        echo "<td bgcolor='#64FE2E'>" . number_format((( $diferencia2 * $kmLineales) / 100) / $tiempo_FDC, 2) . "  Km</td>";
                                    }
                                    ...
                                    echo "<td >" . $kmrecorridosDia . "  Km</td></tr>";
                                } else {
...
//                        //porcentaje de avance por dia
                                        ...
                                        echo "<td>" . number_format(( $diferenciaKMApro * $kmLineales) / 100, 2) . " Km</td>";
                                        ...
                                        if (number_format((( $diferencia2 * $kmLineales) / 100) / $tiempo_FDC, 2) < 5) {
